...
function StreetView({ spot, spots, onSelect, darkMode, onToggleTheme }: { spot: Spot; spots: Spot[]; onSelect: (spot: Spot) => void; darkMode: boolean; onToggleTheme: () => void }) {
  // WebViews are not a reliable host for the full Google Maps application. Use
  // Google's keyless thumbnail endpoint for the in-app preview, and keep the
  // interactive Maps URL for the explicit full-view action.
