...
function StreetView({ spot, spots, onSelect, darkMode, onToggleTheme }: { spot: Spot; spots: Spot[]; onSelect: (spot: Spot) => void; darkMode: boolean; onToggleTheme: () => void }) {
  ...
  const embedSource = `https://maps.google.com/maps?q=&layer=c&cbll=${spot.latitude},${spot.longitude}&cbp=11,${spot.heading},0,0,0&output=svembed&hl=en`;
...
const styles = StyleSheet.create({
  ...
  webOpen: { paddingHorizontal: 10, paddingVertical: 7 }, webOpenText: { color: "#247b52", fontSize: 10, fontWeight: "800" },
});
